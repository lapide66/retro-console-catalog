window.consoleData = {
  ...
  hardware: {
    ...
    gpu: "Sem processador gráfico dedicado",
    ram: "Sem RAM programável",
    midia: "Cartões de circuito",
    resolucao: "Saída de vídeo analógica"
  },

  mercado: {
    precoLancamento: "US$ 99,95",
    precoFonte: "https://www.indianapolismonthly.com/longform/magnavox-odyssey-ralph-baer/",
    vendasTotais: "Cerca de 350 mil unidades",
    vendasFonte: "https://www.indianapolismonthly.com/longform/magnavox-odyssey-ralph-baer/"
  },

  detalhes: {
    dimensoes: "43,2 × 44,5 × 15,2 cm",
    peso: "2 kg",
    retrocompatibilidade: "Nenhuma",
    conectividade: "Saída RF, 2 controles com cabos"
  },
